...
from blueprint.contact import *
from blueprint.convert import *
import os
...
def get_file(filename):
    """
    Return the image with specified filename
    Args:
